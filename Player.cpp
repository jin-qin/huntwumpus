...
public:
    ...
    {{Tile(1,0,0,0,0,0,1,1), //0,0
        Tile(0,3,3,0,3,0,0,0), //0,1
        Tile(0,3,3,3,3,3,0,0), //0,2
        Tile(0,3,3,3,3,3,0,0), //0,3
        Tile(0,3,3,3,3,3,0,0)}, //0,4
        {Tile(0,3,3,0,3,0,0,0), //1,0
            Tile(0,3,3,3,3,3,0,0), //1,1
            Tile(0,3,3,3,3,3,0,0), //1,2
            Tile(0,3,3,3,3,3,0,0), //1,3
            Tile(0,3,3,3,3,3,0,0)}, //1,4
        {Tile(0,3,3,3,3,3,0,0), //2,0
            Tile(0,3,3,3,3,3,0,0), //2,1
            Tile(0,3,3,3,3,3,0,0), //2,2
            Tile(0,3,3,3,3,3,0,0), //2,3
            Tile(0,3,3,3,3,3,0,0)}, //2,4
        {Tile(0,3,3,3,3,3,0,0), //3,0
            Tile(0,3,3,3,3,3,0,0), //3,1
            Tile(0,3,3,3,3,3,0,0), //3,2
            Tile(0,3,3,3,3,3,0,0), //3,3
            Tile(0,3,3,3,3,3,0,0)}, //3,4
        {Tile(0,3,3,3,3,3,0,0), //4,0
            Tile(0,3,3,3,3,3,0,0), //4,1
            Tile(0,3,3,3,3,3,0,0), //4,2
            Tile(0,3,3,3,3,3,0,0), //4,3
            Tile(0,3,3,3,3,3,0,0)} //4,4
    };
